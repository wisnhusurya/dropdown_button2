...
class _DropdownMenu<T> extends StatefulWidget {
  const _DropdownMenu({
    ...
    required this.mediaQueryPadding,
    required this.enableFeedback,
    required this.customNoDataWidget,
  });
        ...
        return ValueListenableBuilder<Rect?>(
          ...
          builder: (BuildContext context, Rect? rect, _) {
            return _DropdownRoutePage<T>(
              ...
              customNoDataWidget: customNoDataWidget,
            );
          },
        );
      },
...
class DropdownButton2<T> extends StatefulWidget {
  ...
  /// A custom widget to display when there are no items
  final Widget? customNoDataWidget;
...
class DropdownButton2State<T> extends State<DropdownButton2<T>>
  ...
  void _handleTap() {
    ...
    _dropdownRoute = _DropdownRoute<T>(
      ...
      customNoDataWidget: widget.customNoDataWidget ?? const SizedBox(),
    );
